    ...
    <div class="create">
        ...
        <form action="{{ route('admin.tags.update', $tag->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" class="form-control @error('name') is-invalid @enderror" aria-describedby="nameHelper" placeholder="Inserisci il nome" value="{{ $tag->name }}">
